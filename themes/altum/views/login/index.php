                ...
                <div class="card-body shadow-md p-5">
                    ...
                    <form action="" method="post" class="mt-4" role="form">
                        <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control form-control-lg" placeholder="<?= $this->language->login->form->email_placeholder ?>" value="<?= $data->values['email'] ?>" required="required" />
                        </div>

                        <div class="form-group">
                            <label><?= $this->language->login->form->password ?></label>
                            <input type="password" name="password" class="form-control form-control-lg" placeholder="<?= $this->language->login->form->password_placeholder ?>" <?= $data->login_account ? 'value="' . $data->values['password'] . '"' : null ?> required="required" />
                        </div>
