            ...
            <div class="modal-body">
                <form name="update_campaign" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted"><?= $this->language->update_campaign_modal->input->domain_help ?></small>
                        <small class="text-muted"><?= $this->language->update_campaign_modal->input->domain_help2 ?></small>
                    </div>
