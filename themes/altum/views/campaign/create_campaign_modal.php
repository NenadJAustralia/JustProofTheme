            ...
            <div class="modal-body">
                <form name="create_campaign" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted"><?= $this->language->create_campaign_modal->input->domain_help ?></small>
                        <small class="text-muted"><?= $this->language->create_campaign_modal->input->domain_help2 ?></small>
                    </div>
