...
<?php ob_start() ?>
    <div class="form-group">
        <label for="settings_title"><i class="fa fa-fw fa-sm fa-heading text-muted mr-1"></i> <?= $this->language->notification->settings->title ?></label>
    ...
    <div class="d-flex justify-content-between">
        <h3 class="h5"><?= $this->language->notification->settings->engagement_links_categories ?></h3>

        <div>
            <button type="button" id="category_create" class="btn btn-success btn-sm rounded-pill"><i class="fa fa-plus-circle"></i> <?= $this->language->global->create ?></button>
        </div>
    </div>
    ...
    <template id="template_category">
        <div class="category">
            <div class="form-group">
                <label><?= $this->language->notification->settings->title ?></label>
                <input type="text" name="categories[category_index][title]" class="form-control" value="" required="required" />
            </div>

            <div class="form-group">
                <label><?= $this->language->notification->settings->description ?></label>
                <input type="text" name="categories[category_index][description]" class="form-control" value="" />
            </div>

            <div class="d-flex justify-content-between">
                <h3 class="h5"><?= $this->language->notification->settings->engagement_links_categories_links ?></h3>

                <div>
                    <button type="button" id="category_link_create_category_index" class="btn btn-outline-success btn-sm rounded-pill"><i class="fa fa-plus-circle"></i> <?= $this->language->global->create ?></button>
                </div>
            </div>

            <div class="category_links bg-gray-200 p-5 my-3"></div>

            <button type="button" class="category_delete btn btn-outline-danger btn-sm" aria-label="<?= $this->language->global->delete ?>"><i class="fa fa-fw fa-times"></i> <?= $this->language->global->delete ?></button>
    ...
    <template id="template_category_links">
        <div class="category_link">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label><?= $this->language->notification->settings->image ?></label>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label><?= $this->language->notification->settings->url ?></label>
                        <input type="text" name="categories[category_index][links][category_link_index][url]" class="form-control" value="" required="required" />
                    </div>
                </div>
            </div>

            <button type="button" class="category_link_delete btn btn-outline-danger btn-sm" aria-label="<?= $this->language->global->delete ?>"><i class="fa fa-fw fa-times"></i> <?= $this->language->global->delete ?></button>
...
<?php ob_start() ?>
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <div class="form-group">
                <label for="settings_categories_title_color"><?= $this->language->notification->settings->title_color ?></label>
                <div class="input-group">
                    <div class="input-group-prepend">
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                <label for="settings_categories_description_color"><?= $this->language->notification->settings->description_color ?></label>
                <div class="input-group">
                    <div class="input-group-prepend">
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <div class="form-group">
                <label for="settings_categories_links_title_color"><?= $this->language->notification->settings->title_color ?></label>
                <div class="input-group">
                    <div class="input-group-prepend">
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                <label for="settings_categories_links_description_color"><?= $this->language->notification->settings->description_color ?></label>
                <div class="input-group">
                    <div class="input-group-prepend">
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <div class="form-group">
                <label for="settings_categories_links_background_color"><?= $this->language->notification->settings->background_color ?></label>
                <div class="input-group">
                    <div class="input-group-prepend">
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                <label for="settings_categories_links_border_color"><?= $this->language->notification->settings->border_color ?></label>
                <div class="input-group">
                    <div class="input-group-prepend">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-4">
            <div class="form-group">
                ...
                <small class="text-muted"><?= $this->language->notification->settings->border_width_help ?></small>
            </div>
        </div>
    ...
    <div class="custom-control custom-switch mr-3 mb-3">
        ...
        <div>
            <small class="text-muted"><?= $this->language->notification->settings->shadow_help ?></small>
        </div>
    </div>
