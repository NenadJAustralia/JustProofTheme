...
<?php ob_start() ?>
    ...
    <div class="form-group">
        ...
        <input type="text" id="settings_end_date" name="end_date" data-min-date="<?= (new \DateTime())->format('Y-m-d') ?>" class="form-control" value="<?= $data->notification->settings->end_date ?>" autocomplete="off" required="required" />
    </div>
    ...
    <div class="form-group">
        <label for="settings_thank_you_url"><?= $this->language->notification->settings->thank_you_url ?></label>
        ...
        <small class="text-muted"><?= $this->language->notification->settings->thank_you_url_help ?></small>
    </div>
...
<script>
    ...
    $('#settings_end_date').daterangepicker({
        startDate: <?= json_encode($data->notification->settings->end_date) ?>,
