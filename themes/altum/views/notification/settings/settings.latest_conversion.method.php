...
<?php ob_start() ?>
    <div class="form-group">
        <label for="settings_title"><?= $this->language->notification->settings->conversion_title ?></label>
        <input type="text" id="settings_title" name="title" class="form-control" value="<?= $data->notification->settings->title ?>" required="required" />
        <small class="text-muted"><?= $this->language->notification->settings->conversion_title_help ?></small>
    </div>

    <div class="form-group">
        <label for="settings_description"><?= $this->language->notification->settings->conversion_description ?></label>
        ...
        <small class="text-muted"><?= $this->language->notification->settings->conversion_active_help ?></small>
    </div>
    ...
    <div class="form-group">
        ...
        <br /><small class="text-muted"><?= $this->language->notification->settings->conversion_active_help ?></small>
    </div>
...
<div class="form-group">
    ...
    <div class="input-group input-group-sm">
        <div class="input-group-prepend">
            <span class="input-group-text"><?= $this->language->notification->settings->data_trigger_type_webhook ?></span>
        </div>
    ...
    <?php if(count($data->notification->settings->data_triggers_auto)): ?>
        <?php foreach($data->notification->settings->data_triggers_auto as $trigger): ?>
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" name="data_trigger_auto_value[]" class="form-control" value="<?= $trigger->value ?>" placeholder="<?= $this->language->notification->settings->trigger_type_exact_placeholder ?>" aria-label="<?= $this->language->notification->settings->trigger_type_exact_placeholder ?>">
...
<div>
    <button type="button" id="data_trigger_auto_add" class="btn btn-outline-success btn-sm"><i class="fa fa-fw fa-plus-circle"></i> <?= $this->language->notification->settings->data_trigger_auto_add ?></button>
</div>
