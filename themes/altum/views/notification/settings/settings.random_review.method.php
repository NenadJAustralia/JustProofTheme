...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_url"><?= $this->language->notification->settings->reviews_count ?></label>
        ...
        <small class="text-muted"><?= $this->language->notification->settings->reviews_count_help ?></small>
    </div>
