...
<?php ob_start() ?>
    ...
    <div class="custom-control custom-switch mr-3 mb-3">
        ...
        >
        <label class="custom-control-label clickable" for="share_facebook"><i class="fab fa-fw fa-facebook"></i> <?= $this->language->notification->settings->share_facebook ?></label>
    </div>
    ...
    <div class="custom-control custom-switch mr-3 mb-3">
        ...
        >
        <label class="custom-control-label clickable" for="share_twitter"><i class="fab fa-fw fa-twitter"></i> <?= $this->language->notification->settings->share_twitter ?></label>
    </div>
    ...
    <div class="custom-control custom-switch mr-3 mb-3">
        ...
        >
        <label class="custom-control-label clickable" for="share_linkedin"><i class="fab fa-fw fa-linkedin"></i> <?= $this->language->notification->settings->share_linkedin ?></label>
    </div>
