...
$settings = require THEME_PATH . 'views/notification/settings/settings.' . strtolower($data->notification->type) . '.method.php';
?>
        ...
        <?php foreach($data->notification->settings->triggers as $trigger): ?>
            <div class="input-group input-group-sm mb-3">
                <select class="form-control trigger-type-select" name="trigger_type[]">
                    <option value="exact" data-placeholder="<?= $this->language->notification->settings->trigger_type_exact_placeholder ?>" <?= $trigger->type == 'exact' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->trigger_type_exact ?></option>
                    <option value="not_exact" data-placeholder="<?= $this->language->notification->settings->trigger_type_not_exact_placeholder ?>" <?= $trigger->type == 'not_exact' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->trigger_type_not_exact ?></option>
                    <option value="contains" data-placeholder="<?= $this->language->notification->settings->trigger_type_contains_placeholder ?>" <?= $trigger->type == 'contains' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->trigger_type_contains ?></option>
                    <option value="not_contains" data-placeholder="<?= $this->language->notification->settings->trigger_type_not_contains_placeholder ?>" <?= $trigger->type == 'not_contains' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->trigger_type_not_contains ?></option>
                    <option value="starts_with" data-placeholder="<?= $this->language->notification->settings->trigger_type_starts_with_placeholder ?>" <?= $trigger->type == 'starts_with' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->trigger_type_starts_with ?></option>
                    <option value="not_starts_with" data-placeholder="<?= $this->language->notification->settings->trigger_type_not_starts_with_placeholder ?>" <?= $trigger->type == 'not_starts_with' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->trigger_type_not_starts_with ?></option>
                    <option value="ends_with" data-placeholder="<?= $this->language->notification->settings->trigger_type_ends_with_placeholder ?>" <?= $trigger->type == 'ends_with' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->trigger_type_ends_with ?></option>
                    <option value="not_ends_with" data-placeholder="<?= $this->language->notification->settings->trigger_type_not_ends_with_placeholder ?>" <?= $trigger->type == 'not_ends_with' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->trigger_type_not_ends_with ?></option>
                    <option value="page_contains" data-placeholder="<?= $this->language->notification->settings->trigger_type_page_contains_placeholder ?>" <?= $trigger->type == 'page_contains' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->trigger_type_page_contains ?></option>
                </select>

                <input type="text" name="trigger_value[]" class="form-control" value="<?= $trigger->value ?>">

                <button type="button" class="trigger-delete ml-3 btn btn-outline-danger btn-sm" aria-label="<?= $this->language->global->delete ?>"><i class="fa fa-fw fa-times"></i></button>
            </div>
        <?php endforeach ?>
    <?php endif ?>
</div>
...
<div class="mb-3">
    <button type="button" id="trigger_add" class="btn btn-outline-success btn-sm"><i class="fa fa-fw fa-plus-circle"></i> <?= $this->language->notification->settings->trigger_add ?></button>
</div>
...
<div class="form-group">
    <label for="settings_display_frequency"><?= $this->language->notification->settings->display_frequency ?></label>
    <select class="form-control" name="display_frequency">
        <option value="all_time" <?= $data->notification->settings->display_frequency == 'all_time' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->display_frequency_all_time ?></option>
        <option value="once_per_session" <?= $data->notification->settings->display_frequency == 'once_per_session' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->display_frequency_once_per_session ?></option>
        <option value="once_per_browser" <?= $data->notification->settings->display_frequency == 'once_per_browser' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->display_frequency_once_per_browser ?></option>
    </select>
    <small class="text-muted"><?= $this->language->notification->settings->display_frequency_help ?></small>
</div>
...
<div class="custom-control custom-switch mr-3 mb-3">
    ...
    <label class="custom-control-label clickable" for="display_mobile"><i class="fa fa-fw fa-sm fa-mobile text-muted mr-1"></i> <?= $this->language->notification->settings->display_mobile ?></label>
...
<div class="custom-control custom-switch mr-3 mb-3">
    ...
    <label class="custom-control-label clickable" for="display_desktop"><i class="fa fa-fw fa-sm fa-desktop text-muted mr-1"></i> <?= $this->language->notification->settings->display_desktop ?></label>

    <div>
        <small class="text-muted"><?= $this->language->notification->settings->display_desktop_help ?></small>
    </div>
</div>
...
<div class="row">
    <div class="col-12 col-md-6">
        <div class="form-group">
            <label for="settings_on_animation"><?= $this->language->notification->settings->on_animation ?></label>
            <select class="form-control" name="on_animation">
                <option value="fadeIn" <?= $data->notification->settings->on_animation == 'fadeIn' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->on_animation_fadeIn ?></option>
                <option value="slideInUp" <?= $data->notification->settings->on_animation == 'slideInUp' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->on_animation_slideInUp ?></option>
                <option value="slideInDown" <?= $data->notification->settings->on_animation == 'slideInDown' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->on_animation_slideInDown ?></option>
                <option value="zoomIn" <?= $data->notification->settings->on_animation == 'zoomIn' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->on_animation_zoomIn ?></option>
                <option value="bounceIn" <?= $data->notification->settings->on_animation == 'bounceIn' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->on_animation_bounceIn ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="col-12 col-md-6">
        <div class="form-group">
            <label for="settings_off_animation"><?= $this->language->notification->settings->off_animation ?></label>
            <select class="form-control" name="off_animation">
                <option value="fadeOut" <?= $data->notification->settings->off_animation == 'fadeOut' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->off_animation_fadeOut ?></option>
                <option value="slideOutUp" <?= $data->notification->settings->off_animation == 'slideOutUp' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->off_animation_slideOutUp ?></option>
                <option value="slideOutDown" <?= $data->notification->settings->off_animation == 'slideOutDown' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->off_animation_slideOutDown ?></option>
                <option value="zoomOut" <?= $data->notification->settings->off_animation == 'zoomOut' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->off_animation_zoomOut ?></option>
                <option value="bounceOut" <?= $data->notification->settings->off_animation == 'bounceOut' ? 'selected="selected"' : null ?>><?= $this->language->notification->settings->off_animation_bounceOut ?></option>
            </select>
        </div>
    </div>
</div>
...
<div class="mt-5 mb-3 d-flex flex-column flex-md-row justify-content-between align-items-md-center">
    ...
    <div id="notification_preview" class="notification-preview-<?= strtolower($data->notification->type) ?>">
...
<div style="display:none" id="trigger_rule_sample">
    <div class="input-group input-group-sm mb-3">
        <select class="form-control trigger-type-select" name="trigger_type[]">
            <option value="exact" data-placeholder="<?= $this->language->notification->settings->trigger_type_exact_placeholder ?>"><?= $this->language->notification->settings->trigger_type_exact ?></option>
            <option value="not_exact" data-placeholder="<?= $this->language->notification->settings->trigger_type_not_exact_placeholder ?>"><?= $this->language->notification->settings->trigger_type_not_exact ?></option>
            <option value="contains" data-placeholder="<?= $this->language->notification->settings->trigger_type_contains_placeholder ?>"><?= $this->language->notification->settings->trigger_type_contains ?></option>
            <option value="not_contains" data-placeholder="<?= $this->language->notification->settings->trigger_type_not_contains_placeholder ?>"><?= $this->language->notification->settings->trigger_type_not_contains ?></option>
            <option value="starts_with" data-placeholder="<?= $this->language->notification->settings->trigger_type_starts_with_placeholder ?>"><?= $this->language->notification->settings->trigger_type_starts_with ?></option>
            <option value="not_starts_with" data-placeholder="<?= $this->language->notification->settings->trigger_type_not_starts_with_placeholder ?>"><?= $this->language->notification->settings->trigger_type_not_starts_with ?></option>
            <option value="ends_with" data-placeholder="<?= $this->language->notification->settings->trigger_type_ends_with_placeholder ?>"><?= $this->language->notification->settings->trigger_type_ends_with ?></option>
            <option value="not_ends_with" data-placeholder="<?= $this->language->notification->settings->trigger_type_not_ends_with_placeholder ?>"><?= $this->language->notification->settings->trigger_type_not_ends_with ?></option>
            <option value="page_contains" data-placeholder="<?= $this->language->notification->settings->trigger_type_page_contains_placeholder ?>"><?= $this->language->notification->settings->trigger_type_page_contains ?></option>
        </select>
...
<div style="display:none" id="data_trigger_auto_rule_sample">
    <div class="input-group input-group-sm mb-3">
        <select class="form-control trigger-type-select" name="data_trigger_auto_type[]">
            <option value="exact"><?= $this->language->notification->settings->trigger_type_exact ?></option>
            <option value="contains"><?= $this->language->notification->settings->trigger_type_contains ?></option>
            <option value="starts_with"><?= $this->language->notification->settings->trigger_type_starts_with ?></option>
            <option value="ends_with"><?= $this->language->notification->settings->trigger_type_ends_with ?></option>
            <option value="page_contains"><?= $this->language->notification->settings->trigger_type_page_contains ?></option>
        </select>

        <input type="text" name="data_trigger_auto_value[]" class="form-control" placeholder="<?= $this->language->notification->settings->trigger_type_exact_placeholder ?>" aria-label="<?= $this->language->notification->settings->trigger_type_exact_placeholder ?>">

        <button type="button" class="data-trigger-auto-delete ml-3 btn btn-outline-danger btn-sm" aria-label="<?= $this->language->global->delete ?>"><i class="fa fa-fw fa-times"></i></button>
    </div>
</div>
