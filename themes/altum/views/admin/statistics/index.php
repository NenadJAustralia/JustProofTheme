...
<div class="row">
    <div class="mb-5 mb-xl-0 col-12 col-xl-3">
        <div class="nav flex-column nav-pills">
            ...
            <?php endif ?>
            <a class="nav-link <?= $data->type == 'notifications' ? 'active' : null ?>" href="<?= url('admin/statistics/notifications?start_date=' . $data->date->start_date . '&end_date=' . $data->date->end_date) ?>"><i class="fa fa-fw fa-sm fa-bell mr-1"></i> <?= $this->language->admin_statistics->notifications->menu ?></a>
        </div>
    </div>
