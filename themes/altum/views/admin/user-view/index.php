        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control-plaintext" value="<?= $data->user->plan_expiration_date ?>" readonly />
                </div>
            </div>
            ...
            <div class="col-12 col-md-4">
                <div class="form-group">
                    <label class="font-weight-bold"><?= $this->language->admin_user_view->main->current_month_notifications_impressions ?></label>
                    <input type="text" class="form-control-plaintext" value="<?= $data->user->current_month_notifications_impressions ?>" readonly />
                </div>
            </div>

            <div class="col-12 col-md-4">
                <div class="form-group">
                    <label class="font-weight-bold"><?= $this->language->admin_user_view->main->total_notifications_impressions ?></label>
                    <input type="text" class="form-control-plaintext" value="<?= $data->user->total_notifications_impressions ?>" readonly />
                </div>
            </div>
            ...
            <div class="col-12 col-md-4">
                <div class="form-group">
                    <label class="font-weight-bold"><?= $this->language->admin_user_view->main->timezone ?></label>
...
<div class="my-5 row justify-content-between">
    <div class="col-12 col-sm-6 col-xl-3 mb-4">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-globe mr-1"></i> <?= $this->language->admin_user_view->campaigns ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->user_campaigns_total) ?></span></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-user-shield mr-1"></i> <?= $this->language->admin_user_view->notifications ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->user_notifications_total) ?></span></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            ...
            <div class="bg-gray-200 px-2 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/payments?email=' . $data->user->email) ?>">
