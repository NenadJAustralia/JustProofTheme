                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="main">
                            ...
                            <div class="form-group">
                                ...
                                <select name="default_timezone" class="form-control form-control-lg">
                                    <?php foreach(DateTimeZone::listIdentifiers() as $time_zone) echo '<option value="' . $time_zone . '" ' . (($this->settings->default_timezone == $time_zone) ? 'selected="selected"' : null) . '>' . $time_zone . '</option>' ?>
                                </select>
                            </div>
                        ...
                        <div class="tab-pane fade" id="socialproofo">
                            <div class="form-group">
                                ...
                                <select name="socialproofo_analytics_is_enabled" class="form-control form-control-lg">
                                    <option value="1" <?= $this->settings->socialproofo->analytics_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->yes ?></option>
                                    <option value="0" <?= !$this->settings->socialproofo->analytics_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->no ?></option>
                                </select>
                        ...
                        <div class="tab-pane fade" id="cron">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg disabled" value="<?= $this->settings->cron->reset_date ?>" readonly="readonly" />
                            </div>
                        </div>
