            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <small class="text-muted"><?= $this->language->admin_plans->plan->campaigns_limit_help ?></small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted"><?= $this->language->admin_plans->plan->notifications_limit_help ?></small>
                    </div>

                    <div class="form-group">
                        <label for="notifications_impressions_limit"><?= $this->language->admin_plans->plan->notifications_impressions_limit ?> <small class="text-muted"><?= $this->language->admin_plans->plan->per_month ?></small></label>
                        ...
                        <small class="text-muted"><?= $this->language->admin_plans->plan->notifications_impressions_limit_help ?></small>
                    </div>
