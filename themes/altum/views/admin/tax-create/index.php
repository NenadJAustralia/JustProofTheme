            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <small class="text-muted"><?= $this->language->admin_taxes->main->internal_name_help ?></small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted"><?= $this->language->admin_taxes->main->countries_help ?></small>
                    </div>
                </div>
            </div>
